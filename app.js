...
// ── AI INSIGHT ENGINE ─────────────────────────────────────────────────────────
const AI_PROMPTS={
  week:'You are a WFM expert in E-commerce. Briefly analyze the following Weekly Overview, highlight the 3 most important insights about HC and coverage, and provide 1-2 specific recommendations. Reply in English, max 200 words, Format your response using clear bold headers and bullet points.',
  day:'You are a WFM expert in E-commerce. Analyze the following Daily Detail, identify hours with coverage issues, explain the root cause, and suggest specific shift adjustments. If historical reference data for the same event type is provided in the context, use it to predict which hours are most likely to be peak-inflow hours today, and briefly explain the reasoning. Reply in English, max 200 words, Format your response using clear bold headers and bullet points.',
  ...
  trend:'You are a WFM expert in E-commerce. Analyze the Inflow, HC, and Coverage trends over time, identify patterns, and provide a short-term outlook. Reply in English, max 200 words, Format your response using clear bold headers and bullet points.',
  workmode:'You are a WFM expert in E-commerce. Analyze the WFH vs On-Floor distribution, assess its appropriateness for operational needs, and recommend adjustments if necessary. Reply in English, max 200 words, Format your response using clear bold headers and bullet points.'
};
